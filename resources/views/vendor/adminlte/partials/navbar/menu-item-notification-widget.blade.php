<li class="nav-item">
    ...
    <div id="list_notifications" class="list_notifications" style="display: none; position: absolute;  margin: 9px -86px; box-shadow: 0px 3px 2px 0px rgba(0,0,0,0.3); background: gainsboro; padding: 10px;">
