...
@section('content_header')
    <div style="display:flex; justify-content:space-between" >
        ...
        <ol class="breadcrumb float-sm-right" style="font-size: 13px;">
            <li class="breadcrumb-item"><a href="#">Nota fiscal</a></li>
            ...
            <div class="tabcontainer">
                <div>
                    <ul class="tabheading">
                        <li class="active" rel="tab1" >
                            <a href="#">
                                <small><i class="fas fa-sitemap fa-x3"></i>  Adicionar venda</small>
                            </a>
                        </li>
                        <li rel="tab2">
                            <a href="#">
                                <small><i class="fas fa-plus fa-x3"></i> Listar vendas</small>
                            </a> 
                        </li>
                        <li rel="tab3">
                            <a href="#">
                                <small><i class="fas fa-list fa-x3"></i> Total vendas</small>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="tabbody active" id="tab1" style="display: block;">  
                    ...
                    <div class="categorias_produto">
                        ...
                        <div class="adicionar_venda">
                            <div class="header_card_venda">
                ...
                <div class="tabbody" id="tab2" style="display: none;">
                    <form id="form_adicionar_venda" action="{{route('produtos.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
